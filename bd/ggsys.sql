...
--
-- Servidor: localhost
-- Tempo de Geração: 07/02/2013 às 21h04min
...
CREATE TABLE IF NOT EXISTS `acesso` (
  ...
  `usuario_in` varchar(255) DEFAULT NULL,
  `data_in` date DEFAULT NULL,
  `usuario_up` varchar(255) DEFAULT NULL,
  `data_up` date DEFAULT NULL,
  `del` enum('s','n') DEFAULT 'n',
  `usuario_del` varchar(255) DEFAULT NULL,
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela de Acessos' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `funcoes` (
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela de funcoes' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `grupos` (
  ...
  `ativo` enum('s','n') NOT NULL DEFAULT 's',
  `codigo` int(11) DEFAULT NULL,
  `paroquia_id` int(11) DEFAULT NULL,
  `movimento_id` int(11) DEFAULT NULL,
  `nome` varchar(255) NOT NULL,
  `data_fundacao` date DEFAULT NULL,
  `fundadores` varchar(255) DEFAULT NULL,
  `descricao` text,
  `reunioes_local` text,
  `reunioes_periodicidade` enum('s','m','a') NOT NULL DEFAULT 's',
  `reunioes_dia` varchar(10) DEFAULT NULL,
  `reunioes_horario` varchar(10) DEFAULT NULL,
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela de grupos' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `grupo_participante`
--
...
CREATE TABLE IF NOT EXISTS `grupo_participante` (
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela de Participantes por grupo' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `movimentos` (
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela de movimentos' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `paroquias`
--
...
CREATE TABLE IF NOT EXISTS `paroquias` (
  ...
  `codigo` int(11) DEFAULT NULL,
  `paroquia_id` int(11) DEFAULT NULL,
  `tipo` enum('p','c') DEFAULT 'c',
  `nome` varchar(255) NOT NULL,
  `data_fundacao` date DEFAULT NULL,
  `data_padroeiro` date DEFAULT NULL,
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Tabela de templos' AUTO_INCREMENT=4 ;

--
-- Extraindo dados da tabela `paroquias`
--

INSERT INTO `paroquias` (`id`, `ativo`, `codigo`, `paroquia_id`, `tipo`, `nome`, `data_fundacao`, `data_padroeiro`, `fundador`, `descricao`, `endereco`, `numero`, `complemento`, `cep`, `bairro`, `cidade`, `estado`, `telefone`, `fax`, `email`, `usuario_in`, `data_in`, `usuario_up`, `data_up`, `del`, `usuario_del`, `data_del`) VALUES
(1, 's', NULL, 0, 'p', 'Paróquia Cristo Salvador', '0000-00-00', '0000-00-00', 'Frei Francisco', 'A maior paróquia do estado do maranhão em termos de estrutura', 'Rua 3', 's/n', 'Proximo a FEST', '6590000', 'São Salvador', 'IMPERATRIZ', 'MARANHÃO', '(99)8888-7777', '(99)9999-1111', 'paroquia@paroquia.com', NULL, NULL, NULL, NULL, 'n', NULL, NULL),
(2, 'n', NULL, 1, 'p', 'Paróquia de Nossa Senhora de Fátima', '0000-00-00', '0000-00-00', '0', '0', '0', '0', '0', '0', '0', 'ACRELÂNDIA', 'ACRE', '0', '0', '0', 'admin', '2012-09-06', NULL, NULL, 's', NULL, NULL),
(3, 's', NULL, 0, 'p', 'Paróquia Santo Antonio', '0000-00-00', '0000-00-00', '0', '0', '0', '0', '0', '0', '0', 'ACRELÂNDIA', 'ACRE', '0', '0', '0', 'admin', '2012-09-06', NULL, NULL, 'n', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `participantes` (
  ...
  `uf_emissor` varchar(50) DEFAULT NULL,
  `endereco` varchar(255) DEFAULT NULL,
  `numero` varchar(10) DEFAULT NULL,
  `complemento` varchar(255) DEFAULT NULL,
  `cep` varchar(20) DEFAULT NULL,
  ...
  `fax_comercial` varchar(20) DEFAULT NULL,
  `bairro_comercial` varchar(255) DEFAULT NULL,
  `cidade_comercial` varchar(255) DEFAULT NULL,
  `estado_comercial` varchar(50) DEFAULT NULL,
  `nome_mae` varchar(255) DEFAULT NULL,
  `nome_pai` varchar(255) DEFAULT NULL,
  `correspondencia` enum('r','c') DEFAULT NULL,
  `usuario_in` varchar(255) DEFAULT NULL,
  `data_in` date DEFAULT NULL,
  `usuario_up` varchar(255) DEFAULT NULL,
  `data_up` date DEFAULT NULL,
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela de Participantes' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `data_del` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Tabela de Usuarios' AUTO_INCREMENT=11 ;

--
-- Extraindo dados da tabela `usuarios`
--

INSERT INTO `usuarios` (`id`, `ativo`, `codigo`, `login`, `senha`, `nome`, `data_nascimento`, `local_nascimento`, `uf`, `nacionalidade`, `sexo`, `cpf`, `rg`, `data_emissao`, `orgao_emissor`, `uf_emissor`, `endereco`, `numero`, `complemento`, `cep`, `bairro`, `cidade`, `estado`, `celular1`, `celular2`, `telefone`, `fax`, `email`, `estado_civil`, `conjuge`, `local_trabalho`, `profissao`, `endereco_comercial`, `telefone_comercial`, `fax_comercial`, `bairro_comercial`, `cidade_comercial`, `estado_comercial`, `nome_mae`, `nome_pai`, `correspondencia`, `usuario_in`, `data_in`, `usuario_up`, `data_up`, `del`, `usuario_del`, `data_del`) VALUES
(1, 's', NULL, 'admin', 'c4ca4238a0b923820dcc509a6f75849b', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin@admin.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin', '2012-11-21', NULL, NULL, 'n', NULL, NULL),
(2, 's', NULL, 'admin', 'c84258e9c39059a89ab77d846ddab909', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin@admin.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin', '2012-11-21', NULL, NULL, 's', NULL, NULL),
(3, 's', NULL, 'admin', '32cacb2f994f6b42183a1300d9a3e8d6', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin@admin.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin', '2012-11-21', NULL, NULL, 's', NULL, NULL),
(5, 's', NULL, 'thiagodon', '4350e2d73992c6f32039dc3fda892dec', 'Thiago Costa Coelho EU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '(99)88362375', NULL, '35238824', NULL, 'thiago.don@hotmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's', NULL, NULL),
(6, 's', NULL, 'thiagodon', '2ca126a27e918e0e34f4c36ec61783ab', 'Thiago Costa Coelho', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '(99)88362375', NULL, '35238824', NULL, 'thiago.don@hotmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's', NULL, NULL),
(7, 'n', NULL, 'thiago', '2f5a5942c1a4e83e1091c4f40303c8ca', 'Thiago Costa Coelho 3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '(99)88362375', NULL, '(99)352388824', NULL, 'thiago.don@hotmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's', NULL, NULL),
(8, 's', NULL, 'teste', 'e959088c6049f1104c84c9bde5560a13', 'nome', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'cel', NULL, 'tel', NULL, 'email', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's', NULL, NULL),
(9, 's', NULL, 'felipe', '4d664c12dd0e2937c5318d7ead194d17', 'felipe menezes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '12345678', NULL, '12345678', NULL, 'felipe', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'n', NULL, NULL),
(10, 's', NULL, 'luis', '43d25532e4e1759773233764f9c1bc18', 'luis', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '12345678', NULL, '12345678', NULL, 'luis', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 's', NULL, NULL);
...
--
-- Restrições para a tabela `acesso`
--
ALTER TABLE `acesso`
  ADD CONSTRAINT `acesso_ibfk_1` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
